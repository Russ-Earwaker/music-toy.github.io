// src/board.js (drag absolute fix: lock initial left/top to visual position)
export function initDragBoard(boardSel = '#board') {
  ...
  board.addEventListener('pointerdown', (e) => {
    ...
    // Force absolute positioning and lock element to its current visual spot
    ...
    drag = {
      ...
      startX: e.clientX,
      startY: e.clientY,
      offsetX: parseFloat(el.style.left) || (rect.left - boardRect.left),
      offsetY: parseFloat(el.style.top)  || (rect.top  - boardRect.top),
    };
