...
export const DRAW_SNAKE_TRIGGER_SOUND_VOLUME = 0.68;
...
export const MUSIC_LAYER_POLICY = Object.freeze({
  ...
  densityReliefPrimaryLoop: 0.15,
  densityPenaltySupport: 0.1,
  densityPenaltySparkle: 0.22,
  entryAudibilityWindowSteps: 8,
  entryAudibilityMinAudibleEvents: 3,
  entryAudibilityScoreBoost: 110,
  entryAudibilityQuietGainMult: 1.18,
  entryAudibilityTraceGainMult: 1.35,
  currentForegroundScoreBoost: 120,
  competingForegroundScorePenalty: 110,
  establishingForegroundScoreBoost: 90,
  foundationStructuralScoreBoost: 120,
  foundationStructuralGainBoost: 0.12,
  currentForegroundGainBoost: 0.08,
  competingForegroundGainPenalty: 0.12,
  protectedLoopQuietFloor: 0.5,
  protectedLoopFullFloor: 0.6,
  protectedFoundationQuietFloor: 0.52,
  protectedFoundationFullFloor: 0.64,
  visibleCueQuietFloor: 0.38,
  visibleCueFullFloor: 0.48,
  entryPhraseLoopQuietFloor: 0.42,
  entryPhraseLoopFullFloor: 0.54,
});
export const LOOP_ADMISSION_POLICY = Object.freeze({
  loopLengthSteps: WEAPON_TUNE_STEPS,
  loopRegistrationCycles: 2,
  foregroundLockLoops: 4,
  foregroundLockBoundaryOnly: true,
  foregroundLockTakeoverPenalty: 1,
...
export const callResponseRuntime = {
  ...
  lastCallGroupId: 0,
  lastCallNote: '',
  pendingCallExpiresStepAbs: -1,
  lastResponseStepAbs: -1,
  lastResponseGroupId: 0,
  lastResponseNote: '',
  activeResponseGroupId: 0,
  responseHoldUntilStepAbs: -1,
  responseDirection: 1,
  responsePhraseProgress: 0,
  responsePhraseTargetLength: 0,
};
...
export const musicLaneRuntime = {
  foundationLane: {
    ...
    performerGroupId: 0,
    performerType: '',
    embodimentState: 'vacant',
    carrierState: 'unbound',
...
export const readabilityMetricsRuntime = {
  ...
  musicAuthoredEvents: 0,
  gameplayAuthoredEvents: 0,
