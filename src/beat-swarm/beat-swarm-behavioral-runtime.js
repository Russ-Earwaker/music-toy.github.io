...
function buildInactiveRuntime(enemyLike = null) {
  ...
  return Object.freeze({
    ...
    singleBehaviorId: String(enemy?.singleBehaviorId || '').trim().toLowerCase(),
    groupBehaviorId: String(enemy?.groupBehaviorId || '').trim().toLowerCase(),
    eventBehaviorId: String(enemy?.eventBehaviorId || '').trim().toLowerCase(),
    behaviorPriority: String(enemy?.behaviorPriority || '').trim().toLowerCase(),
    behaviorWindow: String(enemy?.behaviorWindow || '').trim().toLowerCase(),
    behaviorSource: String(enemy?.behaviorSource || '').trim().toLowerCase(),
    singleBehaviorWindow: String(enemy?.singleBehaviorWindow || '').trim().toLowerCase(),
    groupBehaviorWindow: String(enemy?.groupBehaviorWindow || '').trim().toLowerCase(),
    eventBehaviorWindow: String(enemy?.eventBehaviorWindow || '').trim().toLowerCase(),
